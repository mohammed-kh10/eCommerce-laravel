...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo e(asset('assets/css/vendor/animate.css')); ?>">
					...
					<div class="primary-nav-section">
						<div class="container">
							<ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu" >
								...
								<li class="menu-item">
									<a href="<?php echo e(route('product.cart')); ?>" class="link-term mercado-item-title">Cart</a>
								</li>
								<li class="menu-item">
