            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="" class="form-horizontal" wire:submit.prevent="addSlide">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <?php if($image): ?>
                                        <img src="<?php echo e($image->temporaryUrl()); ?>" width="100" alt="">
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <?php if(Session::has('messageAddSlider')): ?>
                            <div class="alert alert-success" role="alert"><?php echo e(Session::get('messageAddSlider')); ?></div>
                        <?php endif; ?>
...
<?php /**PATH C:\xampp\htdocs\eCommerce-laravel\resources\views/livewire/admin/admin-add-home-slider-component.blade.php ENDPATH**/ ?>