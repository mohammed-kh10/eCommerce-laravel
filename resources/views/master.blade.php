...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/vendor/animate.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/css/vendor/flexslider.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/vendor/chosen.min.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/style.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/css/vendor/color-01.css') }}">
    @livewireStyles
</head>
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2021 Mohammed Khaled. All rights reserved</p>
					</div>
