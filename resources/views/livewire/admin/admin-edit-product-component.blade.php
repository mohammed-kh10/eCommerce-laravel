                ...
                <div class="panel-heading">
                    ...
                    <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input
                                        ...
                                        @if($newImage)
                                            <img src="{{$newImage->temporaryUrl()}}" width="70" alt="">
                                        @else
                                            <img src="{{asset('assets/images/products')}}/{{$image}}" width="70" alt="">
                                        @endif
                        ...
                        @if (Session::has('messageUpdateProduct'))
                            <div class="alert alert-success" role="alert">{{Session::get('messageUpdateProduct')}}</div>
                        @endif
